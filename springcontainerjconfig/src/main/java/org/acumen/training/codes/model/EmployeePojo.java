...
public class EmployeePojo {
	private static final Logger LOGGER = Logger.getLogger(EmployeePojo.class.getName());
	//@Value("101")
	...
	@Autowired
	public EmployeePojo(@Value("102") Integer empId, @Value("Kendrick Lamar")String fullname, @Value("23")Integer age ) {
